				...
				{(model) => (
					<div class="flex flex-col gap-4 p-4 border border-gray-100 rounded bg-gray-50/30">
						...
						<div class="w-full aspect-square bg-white rounded border border-gray-100 overflow-hidden flex items-center justify-center relative group p-2">
							...
							{/* Price Tag Overlay */}
							<div class="absolute bottom-2 right-2 bg-black/80 backdrop-blur text-white px-2 py-1 rounded text-xs font-mono">
								{model.rmbPrice} RMB
							</div>
						</div>
						...
						<div>
							...
							<div class="space-y-1.5">
								<div class="flex items-baseline gap-2 text-xs">
									<span class="text-xs font-bold uppercase tracking-widest text-gray-400 w-8 shrink-0">
										配置
									</span>
